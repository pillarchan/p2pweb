...
INSERT INTO `borrow` VALUES (7,200000,10,10000,30,'借钱 搞个项目','借钱 搞个项目借钱 搞个项目借钱 搞个项目借钱 搞个项目借钱 搞个项目借钱 搞个项目',12,0,1,NULL,1),(8,100000,9,10000,7,'2020重在参与','2020重在参与2020重在参与2020重在参与2020重在参与2020重在参与2020重在参与',6,0,2,NULL,1),(9,200000,10,20000,30,'震惊！要搞项目了','震惊！要搞项目了震惊！要搞项目了震惊！要搞项目了震惊！要搞项目了震惊！要搞项目了',24,0,2,NULL,1);
...
CREATE TABLE `user` (
  ...
  `useful_money` bigint(50) DEFAULT NULL COMMENT '可用金额',
  `freezed_money` bigint(50) DEFAULT NULL COMMENT '冻结金额',
...
INSERT INTO `user` VALUES (1,'test','123',18912345678,'2020-02-20 09:29:49','123@qq.com','我是测试2',101000,81000,20000,'2020-02-22 21:35:57',0,'博士',NULL);
...
-- Dump completed on 2020-02-22 22:50:14
