(function($, window, document) {
  ...
  Paging.prototype = {
    ...
    createDom: function() {
      ...
      that.options.jump
        ? (jumpDom =
            '<input type="text" placeholder="1" class="jump-text jumpText" ><button type="button" class="jump-button" >跳转</button>')
        : (jumpDom = '');
      content =
        ...
        wrapLength +
        'px">' +
        '<ul class="pageSelect" style="transition:all ' +
